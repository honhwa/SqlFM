...
namespace SqlFM.Commands
{
    /// <summary>
    /// 关键字小写命令处理器。
    /// 将 SQL 中所有关键字转换为小写（快捷键 Ctrl+B,Ctrl+L）。
    /// </summary>
    internal sealed class CaseLowerCommand
    {
        /// <summary>
        ...
        /// <summary>
        /// 命令 ID，与 VSCT 中 CaseLowerCmdId 一致。
        /// </summary>
        ...
        /// 命令实例，确保单例。
        /// </summary>
        private static CaseLowerCommand? _instance;
        ...
        /// 私有构造函数，防止外部实例化。
        /// </summary>
        private CaseLowerCommand(AsyncPackage package)
        {
        ...
        public static async System.Threading.Tasks.Task InitializeAsync(AsyncPackage package)
        {
            ...
            if (commandService != null)
            {
                ...
                var menuItem = CommandLocalizer.Create(menuCommandId, Execute, "CmdCaseLower");
                commandService.AddCommand(menuItem);
            }

            _instance = new CaseLowerCommand(package);
        }

        /// <summary>
        /// 公开静态方法，供右键菜单 Click 事件直接调用。
        /// </summary>
        public static void ExecuteCaseLower()
        {
        ...
        private static void Execute(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string converted = FormatService.KeywordsToLower(selectedText!);
                ...
                else
                {
                    ...
                    {
                        string converted = FormatService.KeywordsToLower(allText!);
            ...
            {
                System.Diagnostics.Debug.WriteLine($"CaseLowerCommand 执行异常: {ex.Message}");
            }
        }
    }
}
